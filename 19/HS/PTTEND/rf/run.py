...
best = {'Trial-ID': 12, 'Iteration': 1, 'max_depth': 39, 'min_leafs': 6, 'min_split': 17, 'n_trees': 50, 'Objective': 1.575828112756301e-13}
# best = {'Trial-ID': 12, 'Iteration': 1, 'max_depth': 39, 'min_leafs': 6, 'min_split': 17, 'n_trees': 157, 'Objective': 1.575828112756301e-13}
# best = {'Trial-ID': 12, 'Iteration': 1, 'max_depth': 20, 'min_leafs': 5, 'min_split': 10, 'n_trees': 50, 'Objective': 1.575828112756301e-13}
...
train_x,train_y = functions.unison_shuffled_copies(
    data['train_x'].reshape(shp[0],shp[1]*shp[2])[0:20000000],
    data['train_y'][0:20000000,:,0])
X = train_x
y = train_y
